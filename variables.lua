...
MAP_POCKET_FREQ = 0.05
MAP_POCKET_THRESH = 0.9
MAP_DENSE_FREQ = 0.05
MAP_DENSE_THRESH = 0.9
...
PLAYER_COOLDOWN_FRAMES = 8
PLAYER_MOVECOOL_FRAMES = 3

-- PLAYER_MOVE_FRAMES = 1
-- PLAYER_MINE_FRAMES = 1
-- PLAYER_INTERACT_FRAMES = 1
-- PLAYER_COOLDOWN_FRAMES = 1
-- PLAYER_MOVECOOL_FRAMES = 1
