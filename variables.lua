...
MAP_HIGH_ORE_PER_BAND = 30
MAP_STAND_ORE_PER_BAND = 60
MAP_LOW_ORE_PER_BAND = 60
MAP_LOW_ORE_SKEW = 2
...
STOCKPILE_WIDTH = 6
STOCKPILE_HEIGHT = 6
STOCKPILE_ORE_HEIGHT = 5
STOCKPILE_ORE_STACKS = 10
STOCKPILE_GEM_HEIGHT = 4
STOCKPILE_GEM_STACKS = 7
